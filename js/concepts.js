...
然後用矩陣分解(類似 PCA)壓縮成低維向量。直接利用了「全文統計」的資訊。`,
    keyTerms: [
      ...
      { term: "Skip-gram", def: "中心詞預測周圍詞。例:給「吃」預測「蘋果、想」。優點:**罕見詞每次出現都當作中心詞訓練**,訊號穩。" },
      { term: "CBOW", def: "周圍詞預測中心詞(Continuous Bag-of-Words)。例:給「我、今天、想」預測「吃」。優點:**訓練快**,缺點:罕見詞訊號被平均掉。" },
      { term: "Word2Vec", def: "Google 推出,**預測式**訓練(看局部上下文)" },
      { term: "GloVe", def: "Stanford 推出,**全局統計式**(用共現矩陣)" },
      { term: "共現矩陣", def: "一張大表,row/col 都是詞,值是「兩個詞在同一視窗一起出現過幾次」" },
    ],
    confusions: [
      "**Word2Vec 預測式 vs GloVe 統計式** ← 最常考的對比",
      "Skip-gram 中心→周圍(對罕見詞穩),CBOW 周圍→中心(訓練快但罕見詞糊掉)",
