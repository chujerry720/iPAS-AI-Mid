...
**樹模型(XGBoost、Gradient Boosting)** 對 Label Encoding 較免疫(會自己分裂),但**仍可能誤判特徵重要性**。`,
  ...
  },
  {
    ...
    emoji: "📐",
    prerequisites: ["s2c0-1"],
    diagram: `<svg viewBox="0 0 380 240" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="三種標準化方法對照">
  <g font-size="11">
    <text x="190" y="18" text-anchor="middle" font-weight="600" fill="currentColor">同一筆資料 → 三種標準化結果(紅點 = 極端值)</text>
    <text x="20" y="50" font-weight="600" fill="currentColor">原始</text>
    <line x1="80" y1="55" x2="350" y2="55" stroke="#9ca3af"/>
    <g fill="#6b7280">
    ...
    <circle cx="345" cy="55" r="4" fill="#ef4444"/>
    <text x="100" y="72" text-anchor="middle" font-size="9" fill="#6b7280">3萬</text>
    <text x="345" y="72" text-anchor="middle" font-size="9" fill="#ef4444">300萬</text>
    <text x="20" y="105" font-weight="600" fill="#06b6d4">Min-Max</text>
    <line x1="80" y1="110" x2="350" y2="110" stroke="#9ca3af"/>
    <g fill="#06b6d4">
      <circle cx="80" cy="110" r="3"/>
      <circle cx="83" cy="110" r="3"/>
      <circle cx="86" cy="110" r="3"/>
      <circle cx="90" cy="110" r="3"/>
      <circle cx="95" cy="110" r="3"/>
      <circle cx="103" cy="110" r="3"/>
      <circle cx="115" cy="110" r="3"/>
    </g>
    <circle cx="350" cy="110" r="4" fill="#ef4444"/>
    <text x="80" y="127" text-anchor="middle" font-size="9" fill="#6b7280">0</text>
    <text x="350" y="127" text-anchor="middle" font-size="9" fill="#6b7280">1</text>
    <text x="190" y="92" text-anchor="middle" font-size="9" fill="#ef4444" font-style="italic">極端值把其他點壓扁在最左</text>
    <text x="20" y="160" font-weight="600" fill="#a855f7">Z-score</text>
    <line x1="80" y1="165" x2="350" y2="165" stroke="#9ca3af"/>
    <line x1="180" y1="160" x2="180" y2="170" stroke="#9ca3af"/>
    <g fill="#a855f7">
      <circle cx="135" cy="165" r="3"/>
      <circle cx="148" cy="165" r="3"/>
      <circle cx="162" cy="165" r="3"/>
      <circle cx="172" cy="165" r="3"/>
      <circle cx="180" cy="165" r="3"/>
      <circle cx="190" cy="165" r="3"/>
      <circle cx="205" cy="165" r="3"/>
    </g>
    <circle cx="340" cy="165" r="4" fill="#ef4444"/>
    <text x="135" y="182" text-anchor="middle" font-size="9" fill="#6b7280">−1</text>
    <text x="180" y="182" text-anchor="middle" font-size="9" fill="#6b7280">0</text>
    <text x="225" y="182" text-anchor="middle" font-size="9" fill="#6b7280">+1</text>
    <text x="340" y="182" text-anchor="middle" font-size="9" fill="#ef4444">+10</text>
    <text x="20" y="215" font-weight="600" fill="#10b981">Robust</text>
    <line x1="80" y1="220" x2="350" y2="220" stroke="#9ca3af"/>
    <line x1="180" y1="215" x2="180" y2="225" stroke="#9ca3af"/>
    <g fill="#10b981">
      <circle cx="120" cy="220" r="3"/>
      <circle cx="138" cy="220" r="3"/>
      <circle cx="155" cy="220" r="3"/>
    ...
    <text x="120" y="237" text-anchor="middle" font-size="9" fill="#6b7280">−1</text>
    <text x="180" y="237" text-anchor="middle" font-size="9" fill="#6b7280">中位數</text>
    <text x="240" y="237" text-anchor="middle" font-size="9" fill="#6b7280">+1</text>
    <text x="295" y="237" text-anchor="start" font-size="9" fill="#10b981">極端值未失控 ⭐</text>
  </g>
</svg>`,
...
- 常用於金融、感測器資料`,
  ...
  },
  {
    ...
    emoji: "⚖️",
    prerequisites: [],
    diagram: `<svg viewBox="0 0 380 215" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="SMOTE:在少數類間 KNN 內插合成新點">
  <g font-size="11">
    <text x="190" y="18" text-anchor="middle" font-weight="600" fill="currentColor">SMOTE = 在少數類之間用 KNN 內插「合成」新樣本</text>
    <text x="190" y="32" text-anchor="middle" font-size="10" fill="#6b7280">不是複製(會過擬合),而是插在連線上</text>
    <rect x="20" y="42" width="340" height="135" fill="none" stroke="#9ca3af" stroke-dasharray="3,3"/>
    <g fill="#9ca3af">
      <circle cx="50" cy="60" r="3"/><circle cx="80" cy="165" r="3"/><circle cx="100" cy="55" r="3"/>
      <circle cx="60" cy="130" r="3"/><circle cx="200" cy="65" r="3"/><circle cx="240" cy="170" r="3"/>
      <circle cx="280" cy="55" r="3"/><circle cx="320" cy="160" r="3"/><circle cx="350" cy="80" r="3"/>
      <circle cx="160" cy="170" r="3"/><circle cx="220" cy="170" r="3"/><circle cx="40" cy="105" r="3"/>
      <circle cx="340" cy="125" r="3"/><circle cx="180" cy="55" r="3"/><circle cx="300" cy="165" r="3"/>
      <circle cx="120" cy="60" r="3"/><circle cx="260" cy="60" r="3"/><circle cx="90" cy="105" r="3"/>
    </g>
    <line x1="140" y1="100" x2="200" y2="130" stroke="#ef4444" stroke-dasharray="3,2" stroke-opacity=".55"/>
    <line x1="200" y1="130" x2="260" y2="105" stroke="#ef4444" stroke-dasharray="3,2" stroke-opacity=".55"/>
    <line x1="140" y1="100" x2="260" y2="105" stroke="#ef4444" stroke-dasharray="3,2" stroke-opacity=".35"/>
    <g fill="#ef4444">
      <circle cx="140" cy="100" r="5"/>
      <circle cx="200" cy="130" r="5"/>
      <circle cx="260" cy="105" r="5"/>
    </g>
    <g fill="none" stroke="#ef4444" stroke-width="2">
      <circle cx="170" cy="115" r="4.5"/>
      <circle cx="230" cy="117" r="4.5"/>
      <circle cx="200" cy="103" r="4.5"/>
    </g>
    <g font-size="10" fill="#6b7280">
      <circle cx="40" cy="200" r="3" fill="#9ca3af"/>
      <text x="50" y="203" fill="currentColor">多數類</text>
      <circle cx="120" cy="200" r="4" fill="#ef4444"/>
      <text x="130" y="203" fill="currentColor">少數類</text>
      <circle cx="210" cy="200" r="4.5" fill="none" stroke="#ef4444" stroke-width="2"/>
      <text x="222" y="203" fill="currentColor">合成的新樣本</text>
    </g>
  </g>
</svg>`,
...
\`\`\``,
  ...
  },
  {
    ...
    diagram: `<svg viewBox="0 0 380 220" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="sklearn vs statsmodels API 順序陷阱">
  <g font-size="11">
    <text x="190" y="18" text-anchor="middle" font-weight="600" fill="currentColor">同樣是迴歸,API 參數順序剛好相反</text>
    <rect x="15" y="40" width="170" height="130" rx="6" fill="#06b6d4" fill-opacity=".10" stroke="#06b6d4"/>
    <text x="100" y="60" text-anchor="middle" font-weight="600" fill="#06b6d4">sklearn</text>
    <text x="100" y="78" text-anchor="middle" font-size="10" fill="#6b7280">機器學習</text>
    <g font-family="monospace" font-size="13" text-anchor="middle">
      <text x="100" y="110" fill="currentColor">reg.fit(<tspan font-size="20" font-weight="700" fill="#06b6d4">X</tspan>, <tspan font-size="20" font-weight="700" fill="#06b6d4">y</tspan>)</text>
    </g>
    <text x="100" y="140" text-anchor="middle" font-size="11" fill="currentColor">X 在前,y 在後</text>
    <text x="100" y="158" text-anchor="middle" font-size="10" fill="#6b7280">.coef_ / .intercept_</text>
    <rect x="195" y="40" width="170" height="130" rx="6" fill="#f97316" fill-opacity=".10" stroke="#f97316"/>
    <text x="280" y="60" text-anchor="middle" font-weight="600" fill="#f97316">statsmodels</text>
    <text x="280" y="78" text-anchor="middle" font-size="10" fill="#6b7280">統計報表</text>
    <g font-family="monospace" font-size="13" text-anchor="middle">
      <text x="280" y="110" fill="currentColor">sm.OLS(<tspan font-size="20" font-weight="700" fill="#f97316">y</tspan>, <tspan font-size="20" font-weight="700" fill="#f97316">X</tspan>)</text>
    </g>
    <text x="280" y="140" text-anchor="middle" font-size="11" fill="currentColor">y 在前,X 在後 ⚠</text>
    <text x="280" y="158" text-anchor="middle" font-size="10" fill="#6b7280">先 add_constant!</text>
    <line x1="155" y1="195" x2="225" y2="195" stroke="#ef4444" stroke-width="1.5" stroke-dasharray="3,3"/>
    <text x="190" y="190" text-anchor="middle" font-size="11" fill="#ef4444" font-weight="600">⟷ 順序相反</text>
    <text x="190" y="212" text-anchor="middle" font-size="10" fill="#6b7280" font-style="italic">最常考的命題坑</text>
  </g>
</svg>`,
